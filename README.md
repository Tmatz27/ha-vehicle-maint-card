...
`v0.1.0` is the next release candidate and requires live Home Assistant acceptance testing before the user creates a tag or release. The manifest, bundled card, frontend cache URL, documentation, and changelog use the same version.
